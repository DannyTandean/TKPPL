(function(namespace) {
	...
	Cactus.prototype.colliders = function(offset) {
		return [{
			...
			y: this.y,
			width: 10 * this.scale,
			height: (10 + (15 * Math.max(this.centerSize, this.leftSize, this.rightSize))) * this.scale
		}];
	};
